...
module.exports = {
	...
	version: function (success, failure) {
        cordova.exec(success, failure, "ClassicBluetooth", "version", []);
    },
    ...
    connect: function (id, success, failure) {
        cordova.exec(success, failure, "ClassicBluetooth", "connect", [id]);
    },
    ...
    disconnect: function (success, failure) {
        cordova.exec(success, failure, "ClassicBluetooth", "disconnect", []);
    },
    ...
    devices: function (success, failure) {
        cordova.exec(success, failure, "ClassicBluetooth", "list", []);
    },
    ...
    isConnected: function (success, failure) {
        cordova.exec(success, failure, "ClassicBluetooth", "isConnected", []);
    },
    ...
    write: function (data, success, failure) {
        cordova.exec(success, failure, "ClassicBluetooth", "write", [data]);
    },
    ...
    subscribe: function (success, failure) {
        cordova.exec(success, failure, "ClassicBluetooth", "subscribe", []);
    },
	 ...
	 * @param {function} failure A function called if reflashin has failed
	...
	reflash: function(complete, failure, progress) {
		...
		cordova.exec(success, failure, "ClassicBluetooth", "reflash", []);
	}
};